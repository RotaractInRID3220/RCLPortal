...
export const APP_CONFIG = {
  ...
  REGISTRATION_OPENING_DATE: '2025-10-10T00:00:00', // Date and time from which registration is enabled (YYYY-MM-DDTHH:mm:ss)
  REGISTRATION_DEADLINE: '2025-10-18T23:59:59', // Date and time after which registration/deletion is disabled (YYYY-MM-DDTHH:mm:ss)
  CURRENT_SPORT_DAY: SPORT_DAYS.DAY_01.value, // Current sport day for on-the-day registrations
  MEMBERSHIP_CUTOFF_DATE: '2025-11-01T20:25:53.000Z', // Set cutoff date as 'YYYY-MM-DDTHH:mm:ss' or leave empty for current date
